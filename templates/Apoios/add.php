...
<div class="row g-3">
    ...
    <div class="card shadow-sm">
        ...
        <div class="card-body">
            ...
            <fieldset>
                <?php
                    echo $this->Form->control('nomedoevento', ['class' => 'form-control', 'label' => ['text' => __('Evento'), 'class' => 'form-label']]);
                    echo $this->Form->control('evento_id', ['options' => $eventos, 'class' => 'form-select', 'label' => ['text' => __('Evento'), 'class' => 'form-label']]);
                    echo $this->Form->control('caderno', ['class' => 'form-control', 'label' => ['text' => __('Caderno'), 'class' => 'form-label']]);
                    ...
                    echo $this->Form->control('gt', ['class' => 'form-control', 'label' => ['text' => __('Grupo de Trabalho'), 'class' => 'form-label']]);
